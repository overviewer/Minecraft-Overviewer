...
class RegionSet(object):
    ...
    def __init__(self, regiondir, rel):
        ...
        self._blockmap = {
            ...
            'minecraft:cobbled_deepslate': (1083, 0),
            'minecraft:polished_deepslate': (1084, 0),
            'minecraft:deepslate_coal_ore': (1085, 0),
            'minecraft:deepslate_iron_ore': (1086, 0),
            'minecraft:deepslate_copper_ore': (1087, 0),
            'minecraft:deepslate_gold_ore': (1088, 0),
            'minecraft:deepslate_emerald_ore': (1089, 0),
            'minecraft:deepslate_lapis_ore': (1090, 0),
            'minecraft:deepslate_diamond_ore': (1091, 0),
            'minecraft:deepslate_redstone_ore': (1092, 0),
            'minecraft:deepslate_bricks': (1093, 0),
            'minecraft:cracked_deepslate_bricks': (1094, 0),
            'minecraft:deepslate_tiles': (1095, 0),
            'minecraft:cracked_deepslate_tiles': (1096, 0),
            'minecraft:chiseled_deepslate': (1097, 0),

            'minecraft:dripstone_block': (1098, 0),
            'minecraft:smooth_basalt': (1099, 0),
            'minecraft:tuff': (1100, 0),
