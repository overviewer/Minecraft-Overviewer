...
class RegionSet(object):
    ...
    def __init__(self, regiondir, rel):
        ...
        self._blockmap = {
            ...
            'minecraft:crimson_planks': (1035, 0),
            'minecraft:crimson_slab': (1036, 0),
            'minecraft:crimson_pressure_plate': (1037, 0),
            'minecraft:crimson_fence': (1038, 0),
            'minecraft:crimson_fence_gate': (1039, 0),
            'minecraft:crimson_trapdoor': (1040, 0),
            'minecraft:crimson_stairs': (1041, 0),
            'minecraft:crimson_button': (1042, 0),
            'minecraft:crimson_door': (1043, 0),
            'minecraft:crimson_sign': (1044, 0),
            'minecraft:crimson_wall_sign': (1045, 0),
            'minecraft:warped_planks': (1046, 0),
            'minecraft:warped_slab': (1047, 0),
            'minecraft:warped_pressure_plate': (1048, 0),
            'minecraft:warped_fence': (1049, 0),
            'minecraft:warped_fence_gate': (1050, 0),
            'minecraft:warped_trapdoor': (1051, 0),
            'minecraft:warped_stairs': (1052, 0),
            'minecraft:warped_button': (1053, 0),
            'minecraft:warped_door': (1054, 0),
            'minecraft:warped_sign': (1055, 0),
            'minecraft:warped_wall_sign': (1056, 0),
            'minecraft:chiseled_nether_bricks': (1057, 0),
            'minecraft:cracked_nether_bricks': (1058, 0),
            'minecraft:quartz_bricks': (1059, 0),
            'minecraft:crying_obsidian': (1060, 0),
            'minecraft:lodestone': (1061, 0),
            'minecraft:target': (1062, 0),
            'minecraft:respawn_anchor': (1063, 0),
            'minecraft:chain': (1064, 0),
            'minecraft:soul_lantern': (1065, 0),
            'minecraft:soul_fire': (1066, 0),
            'minecraft:soul_wall_torch': (1067, 0),
            'minecraft:soul_torch': (1067, 5),
            'minecraft:nether_sprouts': (1068, 0),
