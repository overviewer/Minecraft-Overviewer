...
enum mc_block_id {
    ...
    block_crimson_planks = 1035,
    block_crimson_slab = 1036,
    block_crimson_pressure_plate = 1037,
    block_crimson_fence = 1038,
    block_crimson_fence_gate = 1039,
    block_crimson_trapdoor = 1040,
    block_crimson_stairs = 1041,
    block_crimson_button = 1042,
    block_crimson_door = 1043,
    block_crimson_sign = 1044,
    block_crimson_wall_sign = 1045,
    block_warped_planks = 1046,
    block_warped_slab = 1047,
    block_warped_pressure_plate = 1048,
    block_warped_fence = 1049,
    block_warped_fence_gate = 1050,
    block_warped_trapdoor = 1051,
    block_warped_stairs = 1052,
    block_warped_button = 1053,
    block_warped_door = 1054,
    block_warped_sign = 1055,
    block_warped_wall_sign = 1056,
    block_chiseled_nether_bricks = 1057,
    block_cracked_nether_bricks = 1058,
    block_quartz_bricks = 1059,
    block_crying_obsidian = 1060,
    block_lodestone = 1061,
    block_target = 1062,
    block_respawn_anchor = 1063,
    block_chain = 1064,
    block_soul_lantern = 1065,
    block_soul_fire = 1066,
    block_soul_torch = 1067,
    block_nether_sprouts = 1068,
