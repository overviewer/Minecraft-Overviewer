...
# Stairs of all types
@material(blockid=[53, 67, 108, 109, 114, 128, 134, 135, 136, 156, 163, 164, 180, 203, 1030, 1031,
          1032, 1041, 1052, 11337, 11338, 11339, 11370, 11371, 11374, 11375, 11376, 11377, 11378,
          11379, 11380, 11381, 11382, 11383, 11384, 11415],
...
def stairs(self, blockid, data):
    ...
    stair_id_to_tex = {
        ...
        67: "cobblestone.png",
        108: "bricks.png",
        109: "stone_bricks.png",
        114: "nether_bricks.png",
        128: "sandstone.png",
        134: "spruce_planks.png",
        135: "birch_planks.png",
        136: "jungle_planks.png",
        156: "quartz_block_side.png",
        163: "acacia_planks.png",
        164: "dark_oak_planks.png",
        180: "red_sandstone.png",
        203: "purpur_block.png",
        1030: "blackstone.png",
        1031: "polished_blackstone.png",
        1032: "polished_blackstone_bricks.png",
        1041: "crimson_planks.png",
        1052: "warped_planks.png",
        11337: "prismarine.png",
        11338: "dark_prismarine.png",
        11339: "prismarine_bricks.png",
        11370: "mossy_stone_bricks.png",
        11371: "mossy_cobblestone.png",
        11374: "sandstone_top.png",
        11375: "quartz_block_side.png",
        11376: "polished_granite.png",
        11377: "polished_diorite.png",
        11378: "polished_andesite.png",
        11379: "stone.png",
        11380: "granite.png",
        11381: "diorite.png",
        11382: "andesite.png",
        11383: "end_stone_bricks.png",
        11384: "red_nether_bricks.png",
        11415: "red_sandstone_top.png",
    }

    texture = self.load_image_texture(BLOCKTEX + stair_id_to_tex[blockid]).copy()
    ...
    special_tops = {
        128: "sandstone_top.png",
        156: "quartz_block_top.png",
        180: "red_sandstone_top.png",
        1030: "blackstone_top.png",
        11375: "quartz_block_top.png",
    }

    if blockid in special_tops:
        texture = self.load_image_texture(BLOCKTEX + special_tops[blockid]).copy()
...
# Doors
# uses pseudo-ancildata found in iterate.c
@material(blockid=[64, 71, 193, 194, 195, 196, 197, 1043, 1054], data=list(range(32)),
          transparent=True)
def door(self, blockid, data):
    # Masked to not clobber block top/bottom, open & hinge data
    data = data & 0b11100 | ((self.rotation + (data & 0b11)) % 4)
    ...
    tex_f = "{}_{}.png".format(door_tex[blockid], "top" if data & 0x08 else "bottom")
    raw_door = self.load_image_texture(BLOCKTEX + tex_f)

    # if you want to render all doors as closed, then force closed to be True
    closed = not bool(data & 0x04)

    # True: hinge on the left (facing same door direction)
    # False: hinge on the right (default single door)
    hinge_on_left = bool(data & 0x10)

    facing = data & 0x03

    # tex_param: { hinge_on_left : { closed : { facing : (flip_before, flip_after, coord) } } }
    tex_param = {
        True: {
        ...
        False: {
            True:  [(True,  False, (0,  6)),
                    ...
                    (False, False, (12, 0)),
                    (False, True,  (12, 6))],
            False: [(True,  True,  (12, 6)),
                    (False, False, (0,  6)),
                    (False, True,  (0,  0)),
                    (True,  False, (12, 0))]
        }
    }
    flip_before, flip_after, coord = tex_param[hinge_on_left][closed][facing]

    img = Image.new("RGBA", (24, 24), self.bgcolor)
    tex = raw_door
    if flip_before:
        # flip first to set the doorknob on the correct side
        tex = tex.transpose(Image.FLIP_LEFT_RIGHT)
    tex = self.transform_image_side(tex)
    if flip_after:
        tex = tex.transpose(Image.FLIP_LEFT_RIGHT)
    alpha_over(img, tex, coord, tex)
...
@material(blockid=[77, 143, 1034, 1042, 1053, 11326, 11327, 11328, 11329, 11330],
          data=[x for x in list(range(16)) if x & 0x07 != 7], transparent=True)
def buttons(self, blockid, data):
    ...
    tex_f = {
        77: "stone.png",
        143: "oak_planks.png",
        1034: "polished_blackstone.png",
        1042: "crimson_planks.png",
        1053: "warped_planks.png",
        11326: "spruce_planks.png",
        11327: "birch_planks.png",
        11328: "jungle_planks.png",
        11329: "acacia_planks.png",
        11330: "dark_oak_planks.png"
    }[blockid]
    t = self.load_image_texture(BLOCKTEX + tex_f).copy()
